          ...
          <div class="sheet">
            ...
            <div class="sheet__content ingredients">
              ...
              <div class="ingredients__sauce">
                ...
                <label v-for="sauceType in saucesItems" :key="sauceType.id" class="radio ingredients__input">
              ...
              <div class="ingredients__filling">
                ...
                <ul class="ingredients__list">
                  <li v-for="ingredientType in ingredientsItems" :key="ingredientType.id" class="ingredients__item">
                    <div class="filling">
                      <img
...
const saucesItems = sauces.map(normalizeSauces);
const sizesItems = sizes.map(normalizeSize);
const ingredientsItems = ingredients.map(normalizeIngredient);
